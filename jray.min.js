...
(function(){angular.module("jray",[]).factory("Inspector",function(){var t;return t=function(){function t(t,n){var r,e;this.scriptName=t,this.fnStr=n,this.fnLines=this.fnStr.split(/\n/),this.linesHit=[],this.linesHitFade=[],e=new Instrumenter,r=e.instrumentSync(this.fnStr,this.scriptName),eval.call(window,r),this.cov=window[e.currentState.trackerVar],this.update=function(){var t,n,r,e,i,o,s;this.linesHit=[],i=this.cov.s;for(t in i)r=i[t],r>0&&(n=this.cov.statementMap[t].start.line,this.linesHit[n]=!0,null==(e=this.linesHitFade)[n]&&(e[n]=0),this.linesHitFade[n]+=r),this.cov.s[t]=0;o=this.linesHitFade,s=[];for(t in o)r=o[t],s.push(this.linesHitFade[t]*=.5);return s}}return t}()}).controller("MainCtrl",["$scope","$timeout","Inspector","ScriptLoader",function(t,n,r,e){var i;return console.info("jray:","Loading scripts..."),t.inspectors=[],(new e).loadAll().then(function(n){var e,i,o,s;for(s=[],i=0,o=n.length;o>i;i++)e=n[i],s.push(t.inspectors.push(new r(e.name,e.source)));return s}),i=function(){var r,e,o,s;for(s=t.inspectors,e=0,o=s.length;o>e;e++)r=s[e],r.update();return n(i,50)},i(),t.lineStyle=function(t,n){var r,e;return n+=1,null!=t.linesHitFade[n]?(r=Math.sqrt(t.linesHitFade[n]),e=~~(15*r),{background:"hsla(205,50%,"+e+"%,1.0)",color:e>100?"black":"white"}):{background:"#000",color:"white"}},t.currentScriptIndex=0,t.focusOnScript=function(n){return t.currentScriptIndex=n},t.doSomething=function(){return window.erasthenes(1e5)}}]).factory("ScriptLoader",["$http","$q",function(t,n){var r;return r=function(){function r(){}return r.prototype.loadAll=function(){var r,e,i;return i=document.querySelectorAll("script[type='text/jray']"),r=function(){var n,r,o;for(o=[],n=0,r=i.length;r>n;n++)e=i[n],console.info("jray:",e.src),o.push(t.get(e.src));return o}(),n.all(r).then(function(t){var n,r,e,i;for(i=[],r=0,e=t.length;e>r;r++)n=t[r],i.push({source:n.data,url:n.config.url,name:n.config.url.split("/").slice(-1)[0]});return i})},r}()}]).run(["ScriptLoader",function(){}]),window.onload=function(){var t;return t=angular.element("<div ng-include src=\"'jray.html'\"></div>"),document.body.appendChild(t[0]),angular.bootstrap(t,["jray"])}}).call(this);
angular.module("jray").run(["$templateCache", function($templateCache) {$templateCache.put("jray.html","<div ng-controller=\"MainCtrl\"><div class=\"thumbnails\"><div ng-repeat=\"inspector in inspectors\" ng-click=\"focusOnScript($index)\" ng-class=\"{current: $index == currentScriptIndex}\" class=\"thumbnail\"><div class=\"script-name\">{{inspector.scriptName}}</div><pre ng-repeat=\"line in inspector.fnLines track by $index\" ng-style=\"lineStyle(inspector,$index)\">{{line}}&nbsp;</pre></div></div><div class=\"inspector\"><pre ng-repeat=\"line in inspectors[ currentScriptIndex ].fnLines track by $index\" ng-style=\"lineStyle(inspectors[ currentScriptIndex ],$index)\">{{line}}&nbsp;</pre></div></div>");}]);